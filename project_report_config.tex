...
% ****************************************************************************************************
\newcommand{\myTitle}{Intelligente Benachrichtigungen für Twitter}
\newcommand{\myModule}{PIB-PA SS 16}
\newcommand{\myDegree}{Bachelor of Science (B.\,Sc.)\xspace}
\newcommand{\myDegreeType}{Bachelor\xspace}
\newcommand{\myDegreeCourse}{Praktische Informatik}
\newcommand{\myName}{Marius Backes 		\\
				     Martin Feick  		\\
				   % Moritz Grill  		\\
				     Niko Kleer    		\\
				     Marek Kohn			\\
...
\newcommand{\myFirstProf}{Prof. Dr.-Ing. Klaus Berberich\xspace}
\newcommand{\mySecondProf}{Dipl-Math. Wolfgang Braun\xspace}
\newcommand{\myLocation}{Saarbrücken\xspace}
\newcommand{\myTime}{30.09.2016\xspace}
...
\PassOptionsToPackage{language=auto,style=numeric, backend=biber,bibencoding=ascii,maxbibnames=50, defernumbers=true, sorting=none}{biblatex}
...
\lstdefinestyle{XML} {
  ...
  tagstyle=\bfseries\color{blue},
  morekeywords={attribute,xmlns,version,type,release, data, source, ref, authorities, by, query, users, id, disabled ,use, expressions, pattern, access, login, page, login, processing, password, username, parameter, default, target, url, - }}
